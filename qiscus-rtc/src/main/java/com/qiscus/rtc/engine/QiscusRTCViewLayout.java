...
public class QiscusRTCViewLayout extends ViewGroup {
    private int xPercent = 0;
    private int yPercent = 0;
    private int widthPercent = 100;
    private int heightPercent = 100;

    public QiscusRTCViewLayout(Context context) {
        super(context);
    }

    public QiscusRTCViewLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public QiscusRTCViewLayout(Context context, AttributeSet attrs, int defStyleAttr) {
